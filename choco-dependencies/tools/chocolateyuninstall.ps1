...
#   $f='C:\Users\ebkr\projects\chocoutils\choco-dependencies\tools\chocolateyuninstall.ps1'
...
$packageArgs = @{
  ...
  softwareName  = 'choco-dependencies*'  #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
